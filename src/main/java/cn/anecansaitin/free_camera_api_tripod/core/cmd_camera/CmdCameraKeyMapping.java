...
public class CmdCameraKeyMapping {
    public static final Lazy<KeyMapping> TEST1 = Lazy.of(() -> new KeyMapping("key." + FreeCameraApiTripod.MODID + ".test1", KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, -1, new KeyMapping.Category(Identifier.fromNamespaceAndPath(FreeCameraApiTripod.MODID, "test1"))));
...
//            CmdCamera cmdCamera = CmdCamera.INSTANCE;
//            cmdCamera.stop();
            ClientUtil.pushGuiLayer(new ClipTestGui());
        }
    }
}
